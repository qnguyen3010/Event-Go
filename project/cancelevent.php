...
$query=mysql_query( "update event_attendee set status = 'Cancel' where user= '$user_id' and event_id = '$event_id'") or die(mysql_error());
if (!$query) { // add this check.
  die('Invalid query: ' . mysql_error());
}
/*$query2 ="select r.event_ID, r.start_time, r.end_time, r.capacity, r.event_fee, r.introduction, l.location_name, l.address1,l.city,l.state, t.type_name, a.status,a.payment_status
								   from registered_event r, event_location l, event_type t, event_attendee a
								   where a.user = '$user_id' and a.event_id = '$event_id' and l.location_ID = r.location and r.type = t.type_ID and a.event_ID = r.event_ID";
...
<!--                <li><a href="#">Create Event</a></li>-->
    ...
    <div class="jumbotron">
      <h1> Succeffully cancel the below event <?php echo $event_id?> </h1>
        ...
        <table class="table table-striped">
          ...
          try {
            ...
            foreach ($data as $row) {
              ...
              print "<td><button type=\"button\" class=\"btn btn-default\"><a href='joinEventAfterDelete.php?event_id=$event_id'>Join</a></button></td>";
              print "            </tr>\n";
            }
          }
