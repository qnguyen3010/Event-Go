...
$query=mysql_query( "update event_attendee set status = 'Active' where user='$userId' and event_id='$event_id'") or die(mysql_error());
//$userRow = [];
...
?>
  ...
  <div class="container">
    ...
    <div class="jumbotron">
      <h1>Join the Event <?php echo $event_id?> Succeffully</h1>
      <p>Enjoy the Event !</p>
